...
public class IndicationdetailUpdateAction extends ActionSupport
{
	...
	public String execute() throws Exception
    {
        try{
			...
			indicationdetail.setEncounter(encounterManager.getEncounter(encounter));
	
			indicationdetail.setService(serviceManager.getService(service));
	
			indicationdetail.setQuantity(quantity);
	
			indicationdetail.setPrice(price);
