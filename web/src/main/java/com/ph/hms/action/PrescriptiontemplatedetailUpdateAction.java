...
public class PrescriptiontemplatedetailUpdateAction extends ActionSupport
{
	...
	public String execute() throws Exception
    {
        try{
        	...
        	Prescriptiontemplatedetail prescriptiontemplatedetail = prescriptiontemplatedetailManager.getPrescriptiontemplatedetail(id);
        	...
        	prescriptiontemplatedetailManager.updatePrescriptiontemplatedetail(prescriptiontemplatedetail);
