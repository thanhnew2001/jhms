...
public class GetHistoryByTypeHeadAction extends ActionSupport
{
   ...
   try{
	   ...
	   if (flag!=null && flag.equalsIgnoreCase("filter")) {
		...
		if (con != null)
		{
			...
			{
				historys = (Collection<History>)historyManager.filter(typehead);
			}
	
			else if (con.equalsIgnoreCase("All"))
			{
				historys = (Collection<History>)historyManager.filterAll(typehead);
			}
			else
			{
				historys = (Collection<History>)historyManager.filterByCon(con, typehead);
			}
		}
		else
		{
