...
public class GetPrescriptiondetailByTypeHeadAction extends ActionSupport
{
   ...
   try{
	   ...
	   if (flag!=null && flag.equalsIgnoreCase("filter")) {
		...
		if (con != null)
		{
			...
			{
				prescriptiondetails = (Collection<Prescriptiondetail>)prescriptiondetailManager.filter(typehead);
			}
	
			else if (con.equalsIgnoreCase("All"))
			{
				prescriptiondetails = (Collection<Prescriptiondetail>)prescriptiondetailManager.filterAll(typehead);
			}
			else
			{
				prescriptiondetails = (Collection<Prescriptiondetail>)prescriptiondetailManager.filterByCon(con, typehead);
			}
		}
		else
		{
