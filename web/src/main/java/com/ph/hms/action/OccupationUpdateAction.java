...
public class OccupationUpdateAction extends ActionSupport
{
	...
	public String execute() throws Exception
    {
        try{
        	...
        	Occupation occupation = occupationManager.getOccupation(id);
        	...
        	occupationManager.updateOccupation(occupation);
