...
public class GetClientByTypeHeadAction extends ActionSupport
{
...
public String execute() throws Exception
{
   try{
	   ...
	   if (flag!=null && flag.equalsIgnoreCase("filter")) {
				...
				clients = (Collection<Client>)clientManager.filterByCreateddate(  sdf.parse( createddate + " 12:00:00" ) );;
				return SUCCESS;
		}
		...
		if (con != null)
		{
			...
			{
				clients = (Collection<Client>)clientManager.filter(typehead);
			}
	
			else if (con.equalsIgnoreCase("All"))
			{
				clients = (Collection<Client>)clientManager.filterAll(typehead);
			}
			else
			{
				clients = (Collection<Client>)clientManager.filterByCon(con, typehead);
			}
		}
		else
		{
