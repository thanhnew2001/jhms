...
public class GetDruginvoiceByTypeHeadAction extends ActionSupport {
	...
	public String execute() throws Exception {
		try {
			...
			if (flag != null && flag.equalsIgnoreCase("filtertax")) {
				...
				druginvoices = druginvoiceManager.getDrugInvoiceByMonthWithTax(month, year, tax, warehouseManager.getWarehouse(warehouseTax));
			...
			if (con != null) {
				if (con.equalsIgnoreCase("")) {
					druginvoices = (Collection<Druginvoice>) druginvoiceManager.filter(typehead);
				}

				else if (con.equalsIgnoreCase("All")) {
					druginvoices = (Collection<Druginvoice>) druginvoiceManager.filterAll(typehead);
				} else {
					druginvoices = (Collection<Druginvoice>) druginvoiceManager.filterByCon(con, typehead);
				}
			} else {
				druginvoices = (Collection<Druginvoice>) druginvoiceManager.filter(typehead);
			}
