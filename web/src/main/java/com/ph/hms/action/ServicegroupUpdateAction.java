...
public class ServicegroupUpdateAction extends ActionSupport
{
	...
	public String execute() throws Exception
    {
        try{
        	...
        	Servicegroup servicegroup = servicegroupManager.getServicegroup(id);
        	...
        	servicegroupManager.updateServicegroup(servicegroup);
