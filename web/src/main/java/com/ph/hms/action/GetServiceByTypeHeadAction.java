...
public class GetServiceByTypeHeadAction extends ActionSupport
{
   ...
   try{
	   ...
	   if (flag!=null && flag.equalsIgnoreCase("filter")) {
		...
		if (con != null)
		{
			...
			{
				services = (Collection<Service>)serviceManager.filter(typehead);
			}
	
			else if (con.equalsIgnoreCase("All"))
			{
				services = (Collection<Service>)serviceManager.filterAll(typehead);
			}
			else
			{
				services = (Collection<Service>)serviceManager.filterByCon(con, typehead);
			}
		}
		else
		{
