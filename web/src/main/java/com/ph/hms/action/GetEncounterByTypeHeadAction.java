...
public class GetEncounterByTypeHeadAction extends ActionSupport {
	...
	public String execute() throws Exception {
		try {
			...
			Solving sol = solvingManager.getSolving(solving);
			...
			if (flag != null && flag.equalsIgnoreCase("filter")) {
				...
				{
					if(!date.equals(""))	filterDate = sdf.parse(date + " 12:00:00");					
				}
				
				if(con==null) filterDate = todayDate;


				encounters = encounterManager.searchEncounterForEncounter(room, filterDate, sol, con);
			}
			...
			solvings = solvingManager.getAllSolvings();
