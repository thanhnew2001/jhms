...
public class SolvingUpdateAction extends ActionSupport
{
	...
	public String execute() throws Exception
    {
        try{
        	...
        	Solving solving = solvingManager.getSolving(id);
			
			
			solving.setNode(node);
	
			solving.setNode(node);
	
			
        	solvingManager.updateSolving(solving);
